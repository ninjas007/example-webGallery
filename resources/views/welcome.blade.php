    ...
    <div id="{{$post->id}}" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Moda Title Image</h4>
          </div>
          <div class="modal-body">
          ...
          <div class="panel-footer">
            ...
            <span class="user-time pull-right">2 mins ago</span>
          </div>
          ...
          <div class="modal-body">
            ...
            <div class="comment-list">
              ...
              @else
                ...
                <p style="color: white; padding: 10px;">{{$comment->content}}</p>
                <div class="panel-footer" style="background-color: #013f72; color: white; ">
                  <span class="user-info">{{$comment->user->name}}</span>
